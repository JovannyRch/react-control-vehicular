...
export default function Welcome({
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="bg-gray-50 text-black/50 black ">
                <img
                    id="background"
                ...
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            ...
                                            className="aspect-video h-full w-full flex-1 rounded-[10px] object-top object-cover drop-shadow-[0px_4px_34px_rgba(0,0,0,0.06)] "
                        ...
                        <footer className="py-16 text-sm text-center text-black ">
